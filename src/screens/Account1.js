        ...
        <View style={[style.main, {backgroundColor: theme.bg, marginTop: 20}]}>
                ...
                <Modal transparent={true} visible={visible}>
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        onPress={() => {
                          setVisible(false), navigation.navigate('Account');
                        }}
                        style={{
                          marginTop: 10,
                          marginHorizontal: 15,
                      ...
                      <View
                        style={[
                          style.divider,
                          {backgroundColor: theme.divider, marginVertical: 15},
                        ]}></View>
                      <TouchableOpacity
                        onPress={() => {
          ...
          <ScrollView
            ...
            <Avatar.Image
              ...
              size={100}
              style={{alignSelf: 'center', backgroundColor: theme.bg}}
            />
            <Text
              style={[style.apptitle, {color: theme.txt, textAlign: 'center'}]}>
              Aslıhan Karadağ
            </Text>
            <Text
              style={[
              ...
              Herkese merhaba, bu yazılımda yüksek puan alacağım.
            </Text>
            ...
            <View
              ...
              <View
                ...
                <View style={{marginLeft: 15, flex: 1}}>
                  <Text style={[style.r12, {color: theme.txt}]}>Kurslar</Text>
              ...
              <View
                ...
                <View style={{marginLeft: 15, flex: 1}}>
                  <Text style={[style.r12, {color: theme.txt}]}>Puan</Text>
            ...
            <View
              ...
              <View
                ...
                <View style={{marginLeft: 15, flex: 1}}>
                  <Text style={[style.r12, {color: theme.txt}]}>Gruplar</Text>
                  <Text style={[style.s18, {color: theme.txt}]}>14</Text>
                </View>
              </View>
              <View style={{marginHorizontal: 10}}></View>
            ...
            <View
              ...
              <Text style={[style.m16, {color: theme.txt, marginLeft: 10}]}>
                Video Kütüphanesi
              </Text>
            </View>
            <View
