    ...
    <SafeAreaView style={[style.area, {backgroundColor: theme.bg}]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          <Image
            source={require('../../assets/image/a26.png')}
            resizeMode="stretch"
            style={{height: 60, width: 60}}></Image>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            source={require('../../assets/image/a27.png')}
            resizeMode="stretch"
            style={{height: 60, width: 60}}></Image>
        </TouchableOpacity>
      </ScrollView>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View
              ...
              <Image
                ...
                resizeMode="stretch"
                style={{height: height / 4.2, width: width / 2.5}}></Image>
            </View>
            <View
              style={{
                width: width - 40,
              ...
              <Image
                source={require('../../assets/image/a24.png')}
                resizeMode="stretch"
                style={{height: height / 4.2, width: width / 2}}></Image>
            </View>
            <View
              style={{
                width: width - 40,
              ...
              <Image
                source={require('../../assets/image/a25.png')}
                resizeMode="stretch"
                style={{height: height / 4.5, width: width / 2}}></Image>
            </View>
          </ScrollView>
        </View>
