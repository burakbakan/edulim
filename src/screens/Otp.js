      ...
      <KeyboardAvoidingView
        ...
        <View style={[style.main, {backgroundColor: theme.bg, marginTop: 20}]}>
          ...
          <ScrollView
            ...
            style={{marginTop: 10}}>
            <Text style={[style.title, {color: theme.txt}]}>SMS Doğrulama</Text>
            <Text style={[style.r14, {color: theme.txt}]}>
              Lütfen cep telefonunuza gönderilen doğrulama kodunuzu giriniz.
            </Text>
            <OtpInputs
              Clipboard={Clipboard}
              numberOfInputs={4}
            ...
            <Text
              style={[
                style.r14,
                {color: theme.txt, textAlign: 'center', marginTop: 30},
              ]}>
              SMS Kodunuz Gelmedi mi?
            </Text>
            <TouchableOpacity onPress={() => navigation.navigate('Signup')}>
              <Text
                style={[
